...
urlpatterns = [
    path('', views.index, name='ges_home'),
    ...
    path('ges_inperiodical', views.input_periodical, name='ges_inperiodical'), 
    path('ges_addperiodical', views.add_periodical, name='ges_addperiodical'), 
